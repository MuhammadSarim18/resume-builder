...
import { } from "../../../public/templates/template_1.png"
        ...
        {cards && (
          <div className="flex justify-center space-x-4">
            <Link href={"/resume-builder"}>
              <Card imageSrc="https://github-banner-gif.s3.us-east-005.backblazeb2.com/template_1.png" title="Template 1" />
              </Link>
            <Link href={"/resume-builder-2"}>
            <Card imageSrc="https://github-banner-gif.s3.us-east-005.backblazeb2.com/template_2.png" title="Template 2" />
            </Link>
          </div>
        )}
      </div>
...
const Card: React.FC<CardProps> = ({ imageSrc, title }) => {
  ...
  return (
    <div
      className={`border rounded-lg p-4 shadow-lg transition-transform transform ${isHovered ? "scale-105" : "scale-100"
        }`}
    ...
    >
      <img
        src={imageSrc}
        alt={title}
        className="w-48 h-52 object-cover rounded-sm mx-auto mb-2"
      />
