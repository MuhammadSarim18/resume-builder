      ...
      <div className="flex items-center justify-between gap-4 mt-3">
        <div className="flex grow items-center gap-2">
          ...
          <input
            ...
            className={`block border-b border-transparent text-lg font-semibold tracking-wide text-white outline-none hover:border-gray-300 hover:shadow-sm focus:border-gray-300 focus:shadow-sm  p-1`}
            value={heading}
            onChange={(e) => setHeading(e.target.value)}
          />
