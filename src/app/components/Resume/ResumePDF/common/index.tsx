...
export const ResumePDFSection2 = ({
  themeColor,
  heading,
  style = {},
  children,
  ...
  <View
    style={{
      ...styles.flexCol,
      gap: spacing["2"],
      marginTop: spacing["4"], // Increase top margin for better separation
      ...style,
    }}
  >
    {heading && (
      <View style={{ ...styles.flexRow, alignItems: "center" }}>
        {/* {themeColor && (
          <View
            style={{
              height: "4pt",
              width: "20pt", // Reduced width
              backgroundColor: themeColor,
              marginRight: spacing["2"], // Reduced right margin
            }}
            debug={DEBUG_RESUME_PDF_FLAG}
          />
        )} */}
        <Text
          style={{
            fontWeight: "bold",
            letterSpacing: "0.5pt", // Slightly increased letter spacing
            backgroundColor: themeColor,
            color: "#fff",
            padding: "5px"
          }}
...
export const ResumePDFLink2 = ({
  ...
  if (isPDF) {
    return (
      <Link src={src} style={{ textDecoration: "none", color: "white" }}>
        {children}
      </Link>
    );
  }
